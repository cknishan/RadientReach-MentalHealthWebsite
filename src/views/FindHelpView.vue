        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div>
                ...
                <div v-if="nearestCenters.length > 0" class="mt-4 shadow-md rounded-lg overflow-hidden">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <ul class="space-y-2">
                            <li v-for="center in nearestCenters" :key="center.id" class="flex justify-between items-center">
...
const fetchMentalHealthCenters = async () => {
    try {
        ...
        console.log('Fetched centers:', JSON.stringify(mentalHealthCenters.value, null, 2));
    } catch (error) {
