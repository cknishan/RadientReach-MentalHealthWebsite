<template>
    ...
    <div class="max-w-4xl mx-auto mt-8 px-8 py-6 bg-white rounded-lg shadow">
        <div class="flex items-center">
            ...
            <p class="ml-2 text-lg font-semibold">Rating: {{ event.rating }} / 5.0 ({{ event.numberOfReviews
                }} reviews)</p>
        </div>
        <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum quibusdam repudiandae, assumenda incidunt at
            voluptatem sint consectetur eum impedit eos laudantium ipsum deleniti et atque expedita illum. Odit, iusto
            temporibus?</p>
    </div>
</template>
